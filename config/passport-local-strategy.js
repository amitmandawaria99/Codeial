...
//authentication using passport(telling passport to use local strategy)(middleware)
...
//check if the user is authenticated(our function)(middleware)
...
//need authenticated user to access in views
